...
;; MacOSX27.0.sdk の libSystem.B.tbd に arm64e.x1-macos という未知のアーキテクチャが
;; 含まれており、cc によるネイティブコンパイル時にリンクエラーが発生する。
;; MacOSX26.5.sdk を明示することで回避する。
(setenv "SDKROOT" "/Library/Developer/CommandLineTools/SDKs/MacOSX26.5.sdk")
