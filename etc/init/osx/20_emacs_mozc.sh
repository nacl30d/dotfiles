...
: "Install mozc" && {
    ...
    e_info "Select Deployment Target (your sdk ver) on \`Interface Builder Document > Document Editing > Builds for\`"
    e_info "Then \`quit\` Xcode.app to return script."
    open -W -a /Applications/Xcode.app ./third_party/breakpad/src/client/mac/sender/Breakpad.xib
